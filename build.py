  ...
  <div class="container">
    ...
    <div class="learning-grid">
      <article class="learning-card" data-learning-kind="course">
        <div class="learning-art learning-art-foundation"><span>Vận hạn</span><p>Hiểu vận, vững lòng<br><em>Biết thời, thuận dòng</em></p></div>
        <div class="learning-card-body"><p class="learning-category">Khóa học · Dành cho người đã biết Tử Vi</p>
          ...
          <p class="learning-date">Khai giảng 28/9</p>
      ...
      <article class="learning-card" data-learning-kind="course">
        <div class="learning-art learning-art-timing"><span>Chuyên sâu</span><p>Hiểu mình sâu hơn<br><em>Chuyển hóa từ bên trong</em></p></div>
      ...
      <article class="learning-card" data-learning-kind="course">
        <div class="learning-art learning-art-healing"><span>Chuyên đề</span><p>Hiểu nền phúc<br><em>Vun bồi nội tâm</em></p></div>
        <div class="learning-card-body"><p class="learning-category">Khóa học · Không cần nền tảng Tử Vi</p>
          ...
          <p class="learning-date">12 – 14 – 15/09 · 19:30 – 22:30</p>
