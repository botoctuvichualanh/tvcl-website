  ...
  <div class="container">
    ...
    <div class="learning-grid">
      <article class="learning-card" data-learning-kind="course">
        <div class="learning-art learning-art-foundation"><img src="luan-van-han/assets/cong-dong.jpg" alt="Cộng đồng Tử Vi Chữa Lành trong buổi gặp gỡ học viên" loading="lazy" decoding="async"></div>
        <div class="learning-card-body"><p class="learning-category">Khóa học · Dành cho người đã biết Tử Vi</p>
          <h3>Tử Vi Luận Vận Hạn</h3><p>Kết nối Nguyên Cục, Đại Vận và Tiểu Vận; nghiệm lý trên lá số của chính mình để hiểu nhịp chuyển cuộc đời và chủ động trước mỗi bước ngoặt.</p>
      ...
      <article class="learning-card" data-learning-kind="course">
        <div class="learning-art learning-art-timing"><img src="khoa-hoc-tu-vi-bi-kip-chua-lanh/assets/og.png" alt="Tử Vi Bí Kíp Ứng Dụng Chữa Lành — Lá số là bản đồ, không phải bản án" loading="lazy" decoding="async"></div>
        <div class="learning-card-body"><p class="learning-category">Khóa học · Tử Vi, Tâm lý &amp; Đạo học</p>
          <h3>Tử Vi Bí Kíp Chữa Lành</h3><p>Dùng lá số như một bản đồ tâm thức để nhận diện niềm tin lõi, những mô thức đang lặp lại và tìm hướng chuyển hóa qua Tử Vi, Tâm lý và Đạo học.</p>
      ...
      <article class="learning-card" data-learning-kind="course">
        <div class="learning-art learning-art-healing"><img src="cung-phuc-duc/assets/celestial-hero.png" alt="Bản đồ sao và hoa sen của khóa Giải Mã Cung Phúc Đức" loading="lazy" decoding="async"></div>
        <div class="learning-card-body"><p class="learning-category">Khóa học · Không cần nền tảng Tử Vi</p>
          <h3>Giải Mã Cung Phúc Đức</h3><p>Khám phá nền phúc, mối liên hệ với gia đình, dòng họ và đời sống tinh thần; học cách quán chiếu để vun bồi nội lực, tìm sự an trú từ bên trong.</p>
